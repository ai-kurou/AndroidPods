...
internal val SINGLE_BATTERY_MODELS: Set<Int> =
    setOf(
        0x0A20, // AirPods Max
...
internal fun appleDeviceImages(modelCode: Int): DeviceImages? = APPLE_DEVICE_IMAGES[modelCode]

private val APPLE_DEVICE_IMAGES: Map<Int, DeviceImages> =
    mapOf(
        0x0220 to
            DeviceImages.Tws(
