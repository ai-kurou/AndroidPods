...
class CheckUpdateUseCaseTest {
    ...
    @Test
    fun `マイナーバージョンが現在より大きい場合はtrueを返す`() =
        runTest {
    ...
    @Test
    fun `パッチバージョンが現在より大きい場合はtrueを返す`() =
        runTest {
    ...
    @Test
    fun `repositoryがnullを返す場合はfalseを返す`() =
        runTest {
